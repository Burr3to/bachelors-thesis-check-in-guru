  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (_, __) => Divider(height: 1, indent: 16, endIndent: 16, color: cs.outlineVariant),
        itemBuilder: (context, index) {
          ...
          if (isDone) {
            return ListTile(
              ...
              title: Text(subtask.title, style: TextStyle(decoration: TextDecoration.lineThrough, color: cs.onSurfaceVariant)),
              subtitle: Text("Completed by: ${subtask.respondentName}", style: const TextStyle(color: Colors.green, fontSize: 12, fontWeight: FontWeight.bold)),
            );
          }
          return CheckboxListTile(
            ...
            subtitle: subtask.description != null ? Text(subtask.description!, style: TextStyle(color: cs.onSurfaceVariant)) : null,
