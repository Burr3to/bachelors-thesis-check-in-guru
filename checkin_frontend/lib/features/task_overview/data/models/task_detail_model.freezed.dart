...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,notes,hash,createdAt,deadLine,lastModifiedAt,createdById,state,subtaskMode,allowedDomain,requiresAuthenticationToComplete,const DeepCollectionEquality().hash(invitations),const DeepCollectionEquality().hash(subtasks));

@override
String toString() {
  return 'TaskDetailModel(id: $id, title: $title, notes: $notes, hash: $hash, createdAt: $createdAt, deadLine: $deadLine, lastModifiedAt: $lastModifiedAt, createdById: $createdById, state: $state, subtaskMode: $subtaskMode, allowedDomain: $allowedDomain, requiresAuthenticationToComplete: $requiresAuthenticationToComplete, invitations: $invitations, subtasks: $subtasks)';
}
...
@useResult
$Res call({
 String id, String title, String? notes, String hash, DateTime createdAt, DateTime deadLine, DateTime lastModifiedAt, String createdById, TaskState state, SubtaskMode subtaskMode, String? allowedDomain, bool requiresAuthenticationToComplete, List<InvitationListModel> invitations, List<SubtaskTemplateListModel> subtasks
});
...
as SubtaskMode,allowedDomain: freezed == allowedDomain ? _self.allowedDomain : allowedDomain // ignore: cast_nullable_to_non_nullable
as String?,requiresAuthenticationToComplete: null == requiresAuthenticationToComplete ? _self.requiresAuthenticationToComplete : requiresAuthenticationToComplete // ignore: cast_nullable_to_non_nullable
as bool,invitations: null == invitations ? _self.invitations : invitations // ignore: cast_nullable_to_non_nullable
as List<InvitationListModel>,subtasks: null == subtasks ? _self.subtasks : subtasks // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String? notes,  String hash,  DateTime createdAt,  DateTime deadLine,  DateTime lastModifiedAt,  String createdById,  TaskState state,  SubtaskMode subtaskMode,  String? allowedDomain,  bool requiresAuthenticationToComplete,  List<InvitationListModel> invitations,  List<SubtaskTemplateListModel> subtasks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskDetailModel() when $default != null:
return $default(_that.id,_that.title,_that.notes,_that.hash,_that.createdAt,_that.deadLine,_that.lastModifiedAt,_that.createdById,_that.state,_that.subtaskMode,_that.allowedDomain,_that.requiresAuthenticationToComplete,_that.invitations,_that.subtasks);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String? notes,  String hash,  DateTime createdAt,  DateTime deadLine,  DateTime lastModifiedAt,  String createdById,  TaskState state,  SubtaskMode subtaskMode,  String? allowedDomain,  bool requiresAuthenticationToComplete,  List<InvitationListModel> invitations,  List<SubtaskTemplateListModel> subtasks)  $default,) {final _that = this;
switch (_that) {
case _TaskDetailModel():
return $default(_that.id,_that.title,_that.notes,_that.hash,_that.createdAt,_that.deadLine,_that.lastModifiedAt,_that.createdById,_that.state,_that.subtaskMode,_that.allowedDomain,_that.requiresAuthenticationToComplete,_that.invitations,_that.subtasks);}
}
...
class _TaskDetailModel implements TaskDetailModel {
  const _TaskDetailModel({required this.id, required this.title, this.notes, required this.hash, required this.createdAt, required this.deadLine, required this.lastModifiedAt, required this.createdById, required this.state, required this.subtaskMode, this.allowedDomain, this.requiresAuthenticationToComplete = true, final  List<InvitationListModel> invitations = const [], final  List<SubtaskTemplateListModel> subtasks = const []}): _invitations = invitations,_subtasks = subtasks;
...
@override@JsonKey() final  bool requiresAuthenticationToComplete;
 final  List<InvitationListModel> _invitations;
@override@JsonKey() List<InvitationListModel> get invitations {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,notes,hash,createdAt,deadLine,lastModifiedAt,createdById,state,subtaskMode,allowedDomain,requiresAuthenticationToComplete,const DeepCollectionEquality().hash(_invitations),const DeepCollectionEquality().hash(_subtasks));
...
as List<InvitationListModel>,subtasks: null == subtasks ? _self._subtasks : subtasks // ignore: cast_nullable_to_non_nullable
as List<SubtaskTemplateListModel>,
  ));
}
