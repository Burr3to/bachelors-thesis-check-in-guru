...
mixin _$TaskSummaryStats {
 ...
 String get taskId; SubtaskMode get mode; double get globalProgress;// Individual Mode polia
 int get totalRespondents; int get completedFull; int get inProgress; int get notStarted;// Shared Mode polia
 int get totalSubtasks; int get completedSubtasks;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,taskId,mode,globalProgress,totalRespondents,completedFull,inProgress,notStarted,totalSubtasks,completedSubtasks);

@override
String toString() {
  return 'TaskSummaryStats(taskId: $taskId, mode: $mode, globalProgress: $globalProgress, totalRespondents: $totalRespondents, completedFull: $completedFull, inProgress: $inProgress, notStarted: $notStarted, totalSubtasks: $totalSubtasks, completedSubtasks: $completedSubtasks)';
}
...
@useResult
$Res call({
 String taskId, SubtaskMode mode, double globalProgress, int totalRespondents, int completedFull, int inProgress, int notStarted, int totalSubtasks, int completedSubtasks
});
...
/// Create a copy of TaskSummaryStats
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? taskId = null,Object? mode = null,Object? globalProgress = null,Object? totalRespondents = null,Object? completedFull = null,Object? inProgress = null,Object? notStarted = null,Object? totalSubtasks = null,Object? completedSubtasks = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String taskId,  SubtaskMode mode,  double globalProgress,  int totalRespondents,  int completedFull,  int inProgress,  int notStarted,  int totalSubtasks,  int completedSubtasks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskSummaryStats() when $default != null:
return $default(_that.taskId,_that.mode,_that.globalProgress,_that.totalRespondents,_that.completedFull,_that.inProgress,_that.notStarted,_that.totalSubtasks,_that.completedSubtasks);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String taskId,  SubtaskMode mode,  double globalProgress,  int totalRespondents,  int completedFull,  int inProgress,  int notStarted,  int totalSubtasks,  int completedSubtasks)  $default,) {final _that = this;
switch (_that) {
case _TaskSummaryStats():
return $default(_that.taskId,_that.mode,_that.globalProgress,_that.totalRespondents,_that.completedFull,_that.inProgress,_that.notStarted,_that.totalSubtasks,_that.completedSubtasks);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String taskId,  SubtaskMode mode,  double globalProgress,  int totalRespondents,  int completedFull,  int inProgress,  int notStarted,  int totalSubtasks,  int completedSubtasks)?  $default,) {final _that = this;
switch (_that) {
case _TaskSummaryStats() when $default != null:
return $default(_that.taskId,_that.mode,_that.globalProgress,_that.totalRespondents,_that.completedFull,_that.inProgress,_that.notStarted,_that.totalSubtasks,_that.completedSubtasks);case _:
  return null;
...
class _TaskSummaryStats implements TaskSummaryStats {
  const _TaskSummaryStats({required this.taskId, required this.mode, required this.globalProgress, this.totalRespondents = 0, this.completedFull = 0, this.inProgress = 0, this.notStarted = 0, this.totalSubtasks = 0, this.completedSubtasks = 0});
...
/// Create a copy of TaskSummaryStats
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? taskId = null,Object? mode = null,Object? globalProgress = null,Object? totalRespondents = null,Object? completedFull = null,Object? inProgress = null,Object? notStarted = null,Object? totalSubtasks = null,Object? completedSubtasks = null,}) {
