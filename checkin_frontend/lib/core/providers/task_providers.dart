...
final taskListProvider = FutureProvider.autoDispose<QueryResult<TaskListModel>>((
  ref,
) async {
...
final allTaskStatsProvider = FutureProvider<Map<String, TaskSummaryStats>>((ref) async {
  ...
  // Prehodíme to na Mapu pre rýchle vyhľadávanie: { "id1": stats1, "id2": stats2 }
